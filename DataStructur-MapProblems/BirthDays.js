/*************************************************************************************
 * Purpose - Writing a Program to generate a birth month of 50 individuals between 
 * the year 92 & 93. Find all the individuals having birthdays in the same month.
 * @version 1.0
 * @author Rekhs
 * @since 12-07-2021
 ******************************************************************************************/
...
let persons = 1;
while (persons <= 50) {
  persons++; // person will increase still it reaches count 50
  //geerating 1 to 12 random number for month
